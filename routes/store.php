...
Route::group(['middleware' => ['clear_cache', 'auth:restaurant','locale']], function () {
	...
	Route::post('update_modifier', 'StoreController@update_modifier')->name('update_modifier');
	Route::post('delete_modifier', 'StoreController@delete_modifier')->name('delete_modifier');
...
//Profile controller
	...
	Route::get('payout_delete/{id}', 'StoreController@payoutDelete')->name('payout_delete');
	Route::get('payout_default/{id}', 'StoreController@payoutDefault')->name('payout_default');
	...
	Route::match(array('GET', 'POST'), 'view_order/{order_id}', 'StoreController@view_order')->name('store_view_order');
