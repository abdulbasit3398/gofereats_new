...
class CreateOrderTable extends Migration {
	...
	public function up() {
		...
		Schema::create($this->set_schema_table, function (Blueprint $table) {
			...
			$table->decimal('owe_amount_distance', 11, 2)->nullable();
			$table->decimal('store_owe_amount', 11, 2)->nullable();
			...
			$table->string('drop_latitude', 50)->nullable();
			$table->string('drop_longitude', 50)->nullable();
			$table->timestamp('declined_at')->nullable();
			$table->timestamp('accepted_at')->nullable();
			$table->timestamp('cancelled_at')->nullable();
			$table->timestamp('delivery_at')->nullable();
			$table->timestamp('completed_at')->nullable();
			$table->string('delivery_type', 200)->nullable();
			$table->string('service_type', 200)->nullable();
			$table->decimal('tips', 11, 2)->nullable();
