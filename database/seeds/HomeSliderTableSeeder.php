...
class HomeSliderTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      DB::table('home_slider')->insert(array(
        ...
        // array('id' => '4','title' => 'Find food you love from local stores and chain favorites.','description' => 'Find food you love from local stores and chain favorites.','type' => '0','status' => '1'),
        ...
        // array('id' => '6','title' => 'Track your food in real time from the store to you.','description' => 'Track your food in real time from the store to you.','type' => '0','status' => '1'),
      ));   
    }
}
