...
return [
	...
	'store' => [
		'ASAP'=>'هكذا',
		'Schedule'=>'جدول',
		'name_of_the_store'=>'ما اسم المتجر؟',
		'store_address'=>'ما هو عنوان متجرك؟',
		...
		'please_select_service_type'=>'يرجى تحديد نوع الخدمة',
		...
		'search_for_store_cuisine'	=> 'ابحث عن متجر أو مطبخ',
		'please_select_from_google_autocomplete' => 'يرجى الاختيار من جوجل الإكمال التلقائي',
		'ssn_last_4'=>'SSN آخر 4',
		'field_required'=>'هذه الخانة مطلوبه',
		'add_item_based_on_min_count' => 'الرجاء إضافة البند استنادا إلى البند العد',
		'enter_greater_value' => 'الرجاء إدخال قيمة أكبر',
		'please_enter_all_required_fields' => 'الرجاء إدخال جميع الحقول المطلوبة',
		'enter_valid_item_price' => 'الرجاء إدخال سعر السلعة صالح',
		'please_enter_value_grt_than_or_equal' =>'الرجاء إدخال أكبر قيمة من أو يساوي 0. ',
		'tips_field_required'=>'نصائح الميدان مطلوب',
		'please_enter_value_grt_than_0' =>'يجب أن تكون القيمة التي تم إدخالها مبشرة من 0.',
		'both'		=>'الكل',
		'delivery'	=>'توصيل',
		'takeaway'	=>'يبعد',
		'personal_id' =>'الهوية الشخصية',
		'ifsc_code'	=>'(كود ifsc) رقم التوصيل',
	],
