...
return [
	...
	'store' => [
		...
		'name_of_the_store' => 'Qual o nome da loja?',
		'store_address' => 'Qual é o endereço da sua loja?',
		...
		'city' => 'Qual é a cidade da sua loja?',
		...
		'please_select_service_type'=>'Por favor, selecione um tipo de serviço',
		...
		'search_for_store_cuisine'	=> 'Procure por loja ou cozinha',
		'please_select_from_google_autocomplete' => 'Selecione a partir do Google autocomplete',
		'ssn_last_4' => 'Ssn Última 4',
		'field_required'=>'Este campo é obrigatório',
		'add_item_based_on_min_count' => 'Por favor, adicione item com base na contagem de itens',
		'enter_greater_value' => 'Proszę wprowadzić wartość większą',
		'please_enter_all_required_fields' => 'Por favor, indique Todos Campos obrigatórios',
		'enter_valid_item_price' => 'Por favor, indique Válido item Preço',
		'please_enter_value_grt_than_0' =>'valor introducido debe ser rallador que 0.',
		'both'	=>'Todos',
		'delivery'	=>'Entrega',
		'takeaway' =>'Leve embora',
		'personal_id' =>'Id pessoal',
		'ifsc_code'	=> 'Número de roteamento (código ifsc)',
	],
