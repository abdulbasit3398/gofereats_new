...
<main id="site-content" role="main">
	<div class="partners">
		...
		<div class="pickup-times my-4 panel-content">
			<h1>Pickup times</h1>
			<p>We aim to have someone pick up your food as soon as it's ready. When a courier arrives at your store will depend on your average prep times, size of the order, time of the day, traffic, and patterns from past deliveries.</p>
			<h6 class="my-4 theme-color">
				TIPS FOR ACCURATE PICKUPS
			</h6>
			<div class="mt-4">
				<h2>Average food preparation times</h2>
