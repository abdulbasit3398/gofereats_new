			...
			<div class="container">
				<div class="banner-txt">
					<div class="col-md-5 col-lg-6 p-0">
						<h1>The fast way to <span>get food to your customers</span>
						</h1>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						...
						<p>{{site_setting('site_name')}} makes a real impact on your business. When your food is featured in the app, new customers can discover it and loyal customers can enjoy it more often. We’ve seen stores increase sales, lower marketing costs, and hire new employees to capitalize on {{site_setting('site_name')}} demand.</p>
					</div>
					<div class="col-md-4">
						<div class="res-img">
						...
						<p>{{site_setting('site_name')}} is the fast way to get food to your customers. With hundreds of delivery partners on the road, you can deliver in an average of 15 minutes and maintain the best possible food quality. You can also track orders from the floor, right to a customer’s door.</p>
					</div>
					<div class="col-md-4">
						<div class="res-img">
