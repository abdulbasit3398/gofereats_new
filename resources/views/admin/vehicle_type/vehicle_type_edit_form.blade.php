              ...
              <div class="card ">
                ...
                {!! Form::open(['url' => $form_action, 'class' => 'form-horizontal','files'=>'true','id'=>'vehicle_form']) !!}
                  ...
                  <input type="hidden" name="action" class="form_type" value="edit">
                    ...
                    <div class="panel" ng-init="translations = {{json_encode(old('translations') ?: @$vehicle_type->translations)}}; removed_translations =  []; errors = {{json_encode($errors->getMessages())}}; result_translations = {{json_encode(@$vehicle_type->translations)}}" ng-cloak>
