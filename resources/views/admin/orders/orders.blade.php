...
<script>
    ...
    {data: 'user_name',name: 'user.name',title: '{{trans("admin_messages.user_name")}}'},
    {data: 'store_name',name: 'store.name',title: '{{trans("admin_messages.store_name")}}'},
    {data: 'total',name: 'total',title: '{{trans("admin_messages.total")}}'},
    {data: 'status',name: 'status',title: '{{trans("admin_messages.order_status")}}'},
  ...
  app.controller('statements', ['$scope', '$http', function($scope, $http) {
    ...
    $('#custom_statement').on('submit', function(e) {
      ...
      oTable.draw();
      $scope.count_section(filter_by);
      e.preventDefault();
    });
    $scope.count_text="Overall Statement";

    $scope.count_section=function(filter_by)
    {
      console.log(filter_by);      
      $http.get(ajax_url_list['sort_order'], {
        params: {
