	...
	<div class="container-fluid">
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					{!! Form::open(['url' => route('admin.update_admin',['id' => $result->id]), 'class' => 'form-horizontal','id'=>'edit_admin_form']) !!}
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-sm-10">
							<div class="form-group">
								{!! Form::select('status', array(''=>'Select','1' => 'Active','0' => 'Inactive'), $result->status, ['class' => 'form-control', 'id' => 'input_status']) !!}
