    ...
    <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-rose card-header-text">
                  <div class="card-text">
                    <h4 class="card-title">Edit Help Subcategory</h4>
                  </div>
                </div>
                
                  <div class="card-body ">
                  {!! Form::open(['url' => ADMIN_URL.'/edit_help_subcategory/'.$result->id, 'class' => 'form-horizontal','id'=>'help_subcategory_form']) !!}
                    <div class="row">
                    ...
                    <span class="text-danger">{{ $errors->first('name') }}</span>
                       ...
                       <div class="row">
                        <label for="input_language" class="col-sm-2 col-form-label">Category</label>
                        <div class="col-sm-6">
                        <div class="form-group">
