  ...
  <div class="container-fluid">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          {!! Form::open(['url' => $form_action, 'class' => 'form-horizontal','id'=>'edit_support_form','files'=>'true']) !!}
             <div class="row">
                <label class="col-sm-2 col-form-label"> Name <span class="required text-danger">*</span></label>
                <div class="col-sm-6">
                    <div class="form-group">
                      {!! Form::text('name',$support->name , ['class' => 'form-control', 'id' => $support->id, 'placeholder' => 'Name' ,($support->id == 1 || $support->id == 2 ) ? 'readonly' : '' ] ) !!}
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                       {!! Form::text('link', $support->link, ['class' => 'form-control', 'id' => 'input_link', 'placeholder' => 'Link']) !!}
                ...
                <div class="col-md-4">
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                    <div class="fileinput-new thumbnail">
                      @if(isset($support->support_image))
                      <img src="{{$support->support_image}}" alt="...">
                      @endif
                    </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                      {!! Form::select('status', array('Active' => 'Active', 'Inactive' => 'Inactive'), $support->status, ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']) !!}
