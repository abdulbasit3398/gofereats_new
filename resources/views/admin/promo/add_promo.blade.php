...
@section('main')
<div class="content" ng-controller="promoController">
                ...
                {!! Form::open(['url' => $form_action, 'class' => 'form-horizontal','id'=>'promo_form']) !!}
                  @csrf
                    ...
                    <div class="promo_price">
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                          {!! Form::text('price',@$promo->price, ['class' => 'form-control', 'id' => 'input_price',]) !!}
                    ...
                    <div class="promo_percentage">
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                          {!! Form::text('percentage',@$promo->percentage, ['class' => 'form-control', 'id' => 'input_percentage',]) !!}
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                        {!! Form::text('start_date',set_date_on_picker(@$promo->start_date), ['class' => 'form-control datepicker', 'id' => 'input_start_date',]) !!}
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                        {!! Form::text('end_date',set_date_on_picker(@$promo->end_date), ['class' => 'form-control datepicker', 'id' => 'input_end_date',]) !!}
                  ...
                  <div class="panel-body">
                    ...
                    <h4 class="box-title text-center">Translations</h4>
                      ...
                      <div class="row">
                      <label for="input_name_@{{$index}}" class="col-sm-2 col-form-label">Code<span class="required text-danger">*</span></label>
                      <div class="col-sm-6">
                        <div class="form-group">
                        {!! Form::text('translations[@{{$index}}][lang_code]', '@{{translation.lang_code}}', ['class' => 'form-control', 'id' => 'input_name_@{{$index}}', 'placeholder' => 'Code']) !!}
