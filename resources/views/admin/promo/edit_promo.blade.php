                  ...
                  @csrf
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        {!! Form::text('start_date',set_date_on_picker(@$promo->start_date), ['class' => 'form-control datepickerfrom', 'id' => 'input_start_date',]) !!}
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group" style="position: relative;">
                        {!! Form::text('end_date',set_date_on_picker(@$promo->end_date), ['class' => 'form-control datepickerto', 'id' => 'input_end_date',]) !!}
                    ...
                    <h4 class="box-title text-center">Translations</h4>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <span class="text-danger ">@{{translation.lang_code}}  @{{ errors['translations.'+$index+'.lang_code'][0] }}</span>
                        </div>
                        </div>
                      </div>                     
