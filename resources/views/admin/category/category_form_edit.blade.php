  ...
  <div class="container-fluid">
    <div class="col-md-12">
      <div class="card ">
        ...
        <div class="card-body">
          {!! Form::open(['url' => $form_action, 'class' => 'form-horizontal','id'=>'ciusine_form','files'=>'true','enctype'=>'multipart/form-data']) !!}
          @csrf
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="fileinput fileinput-new" data-provides="fileinput">
              ...
              <small>@lang('admin_messages.size')(260 x 200)</small>
        ...
        <div class="panel" ng-init="translations = {{json_encode(old('translations') ?: @$cuisine->translations)}}; removed_translations =  []; errors = {{json_encode($errors->getMessages())}}; result_translations = {{json_encode(@$cuisine->translations)}}" ng-cloak>
