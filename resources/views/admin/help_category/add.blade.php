    ...
    <div class="col-md-12">
              <div class="card ">
                <div class="card-header card-header-rose card-header-text">
                  <div class="card-text">
                    <h4 class="card-title">Add help Category</h4>
                  </div>
                </div>
                
                  <div class="card-body ">
                  {!! Form::open(['url' => 'admin/add_help_category', 'class' => 'form-horizontal','id'=>'help_category_form']) !!}
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                        <div class="form-group">
                        {!! Form::select('status', array('Active' => 'Active', 'Inactive' => 'Inactive'), @$help_category->status, ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']) !!}
