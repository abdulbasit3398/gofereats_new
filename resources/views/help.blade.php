...
<main id="site-content" role="main" ng-controller="help">
	<div class="help-page">
		<div class="help-top d-flex">
         ...
         @if($page=='user')
				<div class="help-banner {{$page=='user'?'active':''}}" help-attr="users" style="background-image: url({{url('/')}}/images/banner3.jpg);" >
				...
				<div class="help-banner {{$page=='restaurant'?'active':''}}" help-attr="stores" style="background-image: url({{url('/')}}/images/default-store.jpg);">
					<div class="container d-flex h-100">
						<div class="banner-content my-auto">
							<h1>
								{{trans('messages.profile.having_trouble')}}?
			...
			<div class="container">
				<div class="d-md-flex">
					<div class="help-nav col-md-4 col-lg-3 pl-0">
						<ul>
							<li>
								<a class="help_nav_link {{$page=='user'?'active':''}}" href="{{route('help_page','user')}}" help-attr="users">
							...
							<li>
								<a class="help_nav_link {{$page=='restaurant'?'active':''}}" href="{{route('help_page','restaurant')}}" help-attr="stores">
