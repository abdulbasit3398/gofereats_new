        ...
        <div class="top-panel d-block d-md-flex align-items-center justify-content-between">
            <div class="logo text-center">
                ...
                <a href="{{url('restaurant') }}">
                    <img src="{{site_setting('store_logo','3')}}">
                </a>
                @else
                <a href="{{url('/') }}">
                ...
                <form class="d-flex justify-content-center" name="search">
                    <div class="search-input w-50">
                        ...
                        <input type="text" class="w-100 text-truncate"
                            placeholder="{{trans('messages.enter_delivery_address')}}" value="{{session('location')}}"
                            id="header_location_val" />
                    </div>
                    <div class="select mr-2 mr-lg-3">
                        <select>
                    ...
                    <button class="btn btn-theme text-nowrap" type="submit"
                        id="find_food_header">{{trans('messages.find_food')}}</button>
                </form>
            </div>
            @endif
            ...
            <div class="flex-grow-1 header-search d-flex align-items-center justify-content-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-left recommended">
                                    ...
                                    <ul class="clearfix">
                                        ...
                                        <li>
                                            <a href="{{session('city')}}/{{$recomm->name}}" class="recommended_val"
                                                data-id="{{$recomm->id}}">
                                                {{$recomm->name}}
                                            </a>
                                        </li>
                                ...
                                <div class="col-12 mt-4 mt-md-0 col-md-6 float-right most-popular">
                                    ...
                                    <div class="search-list clearfix">
                                        ...
                                        <div class="search-item"
                                            style="background-image: url({{$popular->category_image}});">
                                            <a href="{{session('city')}}/{{$popular->name}}" data-id="{{$popular->id}}"
                                                class="popular_val">
                ...
                <form class="d-none d-md-none d-lg-block m-0">
                    <div class="search-type d-none d-md-none d-lg-flex justify-content-center align-items-center">
                        <button class="btn btn-primary schedule-btn">Schedule</button>
                        ...
                        <div class="search-input w-75 pr-15 ml-0">
                            <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1">
                                <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Icons-/-Semantic-/-Location" stroke="#262626">
                                        <g id="Group" transform="translate(1.500000, 0.000000)">
                            ...
                            <input type="text" class="w-100 text-truncate" id="location_search"
                                placeholder="{{ trans('messages.store.enter_your_address') }}"
                                value="{{session('locality')}}" />
                        </div>
                    </div>
                ...
                <nav class="navbar navbar-expand-md px-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto" ng-controller="store_side_bar">
                            ...
                            @if(is_user() || !Route::current()->named("restaurant.*"))

                            <li class="nav-item dropdown">
                                <a class="nav-link d-inline-block align-middle user-name p-0 dropdown-toggle"
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn btn-primary"
                                    href="{{route('restaurant.login')}}">{{trans('messages.profile.sign_in')}}</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <label class="switch">
                                    <input type="checkbox" id="store_status_toogle" class="status_check"
                                        {{get_store_user_id(get_current_store_id(),'status')=='1'?"checked=checked":''}}>
                                    <div class="toggle-slider round">
                                        <span
                                            class="store_status_avai {{get_store_user_id(get_current_store_id(),'status')=='1'?'':'d-none'}}">
                                            {{ trans('admin_messages.available') }}
                                        </span>
                                        <span
                                            class="store_status_unavai {{get_store_user_id(get_current_store_id(),'status')=='1'?'d-none':''}}">
