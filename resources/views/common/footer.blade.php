    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary schedule_modal" data-dismiss="modal" data-val="ok">{{trans('messages.store.confirm')}}</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="schedule_modal1" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" data-val="cancel">{{ trans('admin_messages.cancel') }}</button>
                <button type="button" class="btn btn-primary schedule_modal1" data-dismiss="modal" data-val="ok">{{trans('messages.store.confirm')}}</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="schedule_modal_mob" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" data-val="cancel">{{ trans('admin_messages.cancel') }}</button>
                <button type="button" class="btn btn-primary schedule_modal_mob" data-dismiss="modal" data-val="ok">{{trans('messages.store.confirm')}}</button>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="social-links col-12 col-md-3 col-lg-4">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            @if(get_current_root()!='restaurant')
                            <div class="select_lang select">
                                <select id="js-currency-select" class="language-selector footer-select" aria-labelledby="'language-selector-label">
                        ...
                        <ul>
                            ...
                            <li><a href="{{site_setting('join_us_facebook')}}"><i class="icon icon-facebook-letter-logo"></i></a></li>
                            @endif

                            @if(site_setting('join_us_twitter'))
                            <li><a href="{{site_setting('join_us_twitter')}}"><i class="icon icon-twitter-logo-silhouette"></i></a></li>
                            @endif
            ...
            <div class="copyright py-4">
                <div class="row">
                    <div class="col-12 text-center">
                        <p>© {{ now()->year }} Trioangle Technologies Inc.</p>
                    </div>
                </div>
            </div>
        </div>
