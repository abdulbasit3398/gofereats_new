					...
					<div class="documents">
						<div class="document-row py-4 d-md-flex align-items-center text-center">
							<div class="col-md-5 text-md-left">
								<p>{{trans('messages.driver.licence_back')}}
									<!-- <span> - ({{trans('messages.driver.back_reverse')}}) -->
								</span></p>
							</div>
							<div class="col-md-4">
						...
						<div class="document-row py-4 d-md-flex align-items-center text-center">
							<div class="col-md-5 text-md-left">
								<p>{{trans('messages.driver.licence_front')}}
								 <!-- <span>- ({{trans('messages.driver.front')}})</span></p> -->
							</div>
							<div class="col-md-4">
						...
						<div class="document-row py-4 d-md-flex align-items-center text-center">
							<div class="col-md-5 text-md-left">
								<p>{{trans('messages.driver.insurance')}}</p>
							</div>
							<div class="col-md-4">
						...
						<div class="document-row py-4 d-md-flex align-items-center text-center">
							<div class="col-md-5 text-md-left">
								<p>{{trans('messages.driver.registeration_certificate')}}</p>
							</div>
							<div class="col-md-4">
						...
						<div class="document-row py-4 d-md-flex align-items-center text-center">
							<div class="col-md-5 text-md-left">
								<p>{{trans('messages.driver.motor_certiticate')}}</p>
							</div>
							<div class="col-md-4">
