							...
							<div class="table-responsive">
								<table>
									<thead>
										<tr>
											<th></th>
											<th>{{trans('messages.store_dashboard.timings')}}</th>
											<th>{{trans('messages.driver.driver')}}</th>
											<th>{{trans('messages.driver.total_fare')}}</th>
											<th>{{trans('messages.driver.vehicle_type')}}</th>
