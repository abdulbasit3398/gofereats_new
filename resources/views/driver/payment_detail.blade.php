...
<tr>
<td>
{{trans('messages.driver.driver_payout')}}
</td>
<td>
{!!$time_detail['currency_symbol']!!} {{$time_detail['bank_deposits']}}
</td>
...
<tr>
<td>
{{trans('messages.profile_orders.tips')}}
</td>
<td>
{!!$time_detail['currency_symbol']!!} {{$time_detail['tips']}}
</td>
</tr>
...
<td>{!!$value['currency_symbol']!!} {{$value['driver_earning']}}</td>
...
@{{trip_details['order_id']}}
	...
	<tr ng-if="trip_details['tips']>0">
		<td>{{trans('messages.profile_orders.tips')}}</td>
		<td>
			<span ng-bind-html="trip_details['currency_symbol']"> @{{trip_details['currency_symbol']}} </span>@{{trip_details['tips']}}
		</td>
	</tr>
	<tr>
		<td>{{trans('messages.driver.access_fee')}}</td>
