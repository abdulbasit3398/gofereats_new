	...
	<div class="signup-page">
			...
			<div class="container">
				<div class="banner-txt">
					<div class="col-md-5 col-lg-6 p-0">
						<h1>{{trans('messages.driver.deliver_with')}} {{site_setting('site_name')}} 
						<span>{{trans('messages.driver.own_schedule')}}</span>
						</h1>
					</div>
		...
		<div class="stores-info my-5">
			<div class="container info-top">
				<h1>{{trans('messages.driver.new_way')}} <span>{{trans('messages.driver.with')}} {{site_setting('site_name')}}</span></h1>
				<div class="row">
					<div class="col-md-4">
						<div class="res-img">
					...
					<div class="col-md-4">
						...
						<p>{{trans('messages.driver.rules')}} {{site_setting('site_name')}}.</p>
					</div>
					<div class="col-md-4">
						<div class="res-img">
				...
				<div class="start-info my-5">
					...
					<a href="#driver-form" class="driver-form-link btn btn-theme btn-arrow text-uppercase mt-4 mt-md-5">{{trans('messages.driver.get_started')}}
					</a>
				</div>
			</div>
		</div>
...
$("#phone_code").on('change',function(){
	var language_code = $("#phone_code option:selected").val();
	$("#phone_code").val(language_code);
});
