	...
	public function dataTable($query) {
		return datatables($query)
			...
			->addColumn('action', function ($query) {
				...
				return '<a title="' . trans('admin_messages.view') . '" href="' . route('admin.payout_per_day', ['user_id' => $query[0]->user_id, 'start_date' => $start_date, 'end_date' => $end_date]) . '" ><i class="material-icons">library_books</i></a>';
			})
